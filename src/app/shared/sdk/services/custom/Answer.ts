...
export class AnswerApi extends BaseLoopBackApi {
  ...
  /**
   * Fetches belongsTo relation pool.
   *
   ...
   * </em>
   */
  public getPool(id: any, refresh: any = {}, customHeaders?: Function): Observable<any> {
